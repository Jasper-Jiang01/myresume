var _prefersReducedMotion, _coarsePointer$addEve;gsap.registerPlugin(Draggable, InertiaPlugin);
...
function createDraggable() {
  ...
  mode.textContent = useBounds ? "Bounded" : "Free spin";
...
(_prefersReducedMotion = prefersReducedMotion.addEventListener) === null || _prefersReducedMotion === void 0 ? void 0 : _prefersReducedMotion.call(prefersReducedMotion, "change", createDraggable);
(_coarsePointer$addEve = coarsePointer.addEventListener) === null || _coarsePointer$addEve === void 0 ? void 0 : _coarsePointer$addEve.call(coarsePointer, "change", rebuildForLayout);